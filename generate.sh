...
GENERATED="${GOPATH}/src/github.com/dl-solarity/frontend-link-shortener-svc/resources"
OPENAPI_DIR="${GOPATH}/src/github.com/dl-solarity/frontend-link-shortener-svc/docs/web_deploy"
